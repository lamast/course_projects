...
int main()
{
	...
	dress.open("B://Универ//2курс//ООП//ex//Курсовая//rokli.txt", ios::in);
	if (!dress.is_open())
	{
	...
	costume.open("B://Универ//2курс//ООП//ex//Курсовая//kostyumi.txt", ios::in);
	if (!costume.is_open())
	{
	...
	shoes.open("B://Универ//2курс//ООП//ex//Курсовая//obuvki.txt", ios::in);
	if (!shoes.is_open())
	{
	...
	do {
		...
		{ //show orders
			...
			cout << "Average = "<< ord.average() <<"lv." << endl;
	...
	//rokli
	dress.open("B://Универ//2курс//ООП//ex//Курсовая//rokli.txt", ios::out | ios::trunc);
	for (vector <Rokli>::iterator it = rokli.begin(); it != rokli.end(); it++)
	{
	...
	//kostyumi
	costume.open("B://Универ//2курс//ООП//ex//Курсовая//kostyumi.txt", ios::out | ios::trunc);
	for (vector <Kostyumi>::iterator it = kostyumi.begin(); it != kostyumi.end(); it++)
	{
	...
	//obuvki
	shoes.open("B://Универ//2курс//ООП//ex//Курсовая//obuvki.txt", ios::out | ios::trunc);
	for (vector <Obuvki>::iterator it = obuvki.begin(); it != obuvki.end(); it++)
	{
